...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void sendWeatherToWatch() {
        ...
        if (cursor.moveToFirst()) {
            ...
            map.putString(context.getString(R.string.HIGH_TEMP_KEY), highString);
            map.putString(context.getString(R.string.LOW_TEMP_KEY), lowString);
            map.putInt(context.getString(R.string.WEATID_KEY), weatherId);
            map.putString(context.getString(R.string.DESC_KEY), desc);
